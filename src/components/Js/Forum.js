...
export default function RegisterAsWorker() {
  return (
    <>
    <div className="bg-white shadow overflow-hidden sm:rounded-lg container my-5">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-bold text-gray-900">
          Developer  Information
        </h3>
        <p className="mt-1 max-w-2xl font-bold text-sm text-gray-500">
          Personal details of Developer.
        </p>
      </div>
      <div className="border-t border-gray-200">
        <dl>
          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-bold text-gray-500">About</dt>
          ...
          <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-bold text-gray-500">Attachments</dt>
              ...
              >
                <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                  <div className="w-0 flex-1 flex items-center">
                    ...
                    <span className="ml-2 flex-1 w-0 truncate font-bold">
